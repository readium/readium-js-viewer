var pathsReadium = {
    ...
    jquerySizes: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/lib/jquery.sizes',
    ...
    style: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/style',
    styleCollection: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/style_collection',
    triggers: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/trigger',
    smilModel: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/smil_model',
    mediaOverlay: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/media_overlay',
    ...
    smilIterator: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/models/smil_iterator',
    ...
    mediaOverlayElementHighlighter: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/views/media_overlay_element_highlighter',
    audioPlayer: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/views/audio_player',
    mediaOverlayPlayer: '../Readium-Web-Components/epub-modules/epub-renderer/src/readium-shared-js/js/views/media_overlay_player'
