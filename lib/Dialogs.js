...
// console.debug("PROP AFTER: " + e[_prop_name]);
    ...
    var applyKeyboardSettingsAndResetAccessKeys = function()
    {
        Settings.get('reader', function(json)
        {
            ...
            for (prop in Dialogs.keyboard)
            {
                ...
                if (typeof json[prop] !== 'string') continue;
            
                Dialogs.keyboard[prop] = json[prop];
console.log(prop + "=" + Dialogs.keyboard[prop]);
            }
        });
        ...
        for (prop in Dialogs.keyboard)
        {
            ...
            var key = prop + "_accesskey";
            var value = extractAccessKey(str);
            
            Dialogs.keyboard[key] = value;
        }
    };
    applyKeyboardSettingsAndResetAccessKeys();
