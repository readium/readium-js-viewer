define(['jquery', 'bootstrap', 'storage/StorageManager', 'storage/Settings', 'EpubLibraryManager', 'i18n/Strings', 'hgn!templates/library-navbar.html', 
	...
	var loadLibraryUI = function(){
		...
		$('.icon-list-view').on('click', function(){listViewThumbnailViewToggle()});
		$('.icon-thumbnails').on('click', function(){listViewThumbnailViewToggle()});
                
                Keyboard.on(Keyboard.ListViewThumbnailViewToggle, 'library', function (){listViewThumbnailViewToggle()});
