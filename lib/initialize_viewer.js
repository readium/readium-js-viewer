...
require(['jquery', 'underscore', 'bootstrap', 'Readium', 'package_fetcher', 'package_parser', 'package_document'],
    function ($, _, bootstrap, Readium, PackageFetcher, PackageParser, PackageDocument) {
    ...
    RJSDemoApp.loadAndRenderEpub = function (packageDocumentURL) {
        ...
        var _packageFetcher = new PackageFetcher(packageDocumentURL, _jsLibDir);
        var _packageParser = new PackageParser(_packageFetcher);
