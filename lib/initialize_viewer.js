...
/*
        ...
        $("#toggle-synthetic-btn").on("click", function () {
            ...
            if (RJSDemoApp.currLayoutIsSynthetic) {
                _readium.reader.updateSettings({ "isSyntheticSpreadDouble" : false, "isSyntheticSpreadSingle" : true });
                ...
                _readium.reader.updateSettings({ "isSyntheticSpreadDouble" : true, "isSyntheticSpreadSingle" : false });
                RJSDemoApp.currLayoutIsSynthetic = true;
