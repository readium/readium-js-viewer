...
Readium){
    ...
    var loadEbook = function (packageDocumentURL, readerSettings, openPageRequest) {
		...
		var renditionSelection = {
			...
			renditionMediaQueryCallback: _.debounce(function() {
        ...
        }, openPageRequest, renditionSelection);
    };
...
//TODO: UI to allow the user to configure these parameters
readerSettings.renditionSelectionLanguage = "en-UK";
readerSettings.renditionSelectionAccessMode = "textual"; //auditory, tactile, visual
readerSettings.renditionSelectionLayout = "reflowable"; //pre-paginated
