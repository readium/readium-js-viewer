    ...
    var initReadium = function(){
        ...
        Settings.getMultiple(['reader', url], function(settings){
            ...
            ReadiumSDK.on(ReadiumSDK.Events.PLUGINS_LOADED, function () {
                ...
                readium.reader.annotations.initialize({annotationCSSUrl: readerOptions.annotationCSSUrl});
            });
            ...
            readium.reader.annotations.on("annotationClicked", function(type, idref, cfi, id) {
                readium.reader.annotations.removeHighlight(id);
            });
        });
    }
