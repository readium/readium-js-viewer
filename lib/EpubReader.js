...
define(['module','jquery', 'bootstrap', 'URIjs', 'Readium', 'Spinner', 'storage/Settings', 'i18n/Strings', 'Dialogs', 'ReaderSettingsDialog', 
        ...
        'analytics/Analytics', 'screenfull', 'Keyboard', 'EpubReaderMediaOverlays', 'EpubReaderBackgroundAudioTrack', 'gestures'],
        function (module, $, bootstrap, URI, Readium, spinner, Settings, Strings, Dialogs, SettingsDialog,
                  ...
                  Analytics, screenfull, Keyboard, EpubReaderMediaOverlays, EpubReaderBackgroundAudioTrack, GesturesHandler) {
...
catch (e)
{
    ...
    var initReadium = function(){
        ...
        Settings.getMultiple(['reader', url], function(settings){
            ...
            var readerOptions =  {
                ...
                mathJaxUrl: module.config().mathJaxUrl || (prefix  + "/lib/mathjax/MathJax.js")
            };
    ...
    var unloadReaderUI = function(){
        ...
        $('.tooltipx').tooltip('hide');
        $('.tooltipx').off('show.bs.tooltip');
    }
    ...
    var applyKeyboardSettingsAndLoadUi = function(data)
    {
        ...
        Settings.get('reader', function(json)
        {
           ...
           $('.tooltipx').tooltip({placement:'bottom', animation:"false", container:"body", delay: { show: 0, hide: 0 }, trigger: 'focus hover'});
           $('.tooltipx').on('show.bs.tooltip', function () {
               var shown = this;
               $('.tooltipx').each(function( index ) {
                   if (shown != this) {
                       $(this).tooltip('hide');
                   }
               });
