...
define(['jquery', 'bootstrap', 'URIjs', 'Readium', 'storage/Settings', 'ReaderSettingsDialog', 'hgn!templates/reader-navbar.html', 'hgn!templates/reader-body.html'], function ($, bootstrap, URI, Readium, Settings, SettingsDialog, ReaderNavbar, ReaderBody) {
    ...
    var readium, 
        ...
        currentDocument,
        requestFullScreen = el.requestFullscreen || el.webkitRequestFullscreen || el.mozRequestFullScreen || el.msRequestFullscreen || function() {},
        cancelFullScreen = document.exitFullscreen || document.webkitExitFullscreen || document.mozCancelFullScreen || document.msExitFullscreen || function() {};
