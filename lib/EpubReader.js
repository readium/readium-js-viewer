...
// console.debug("PROP AFTER: " + e[_prop_name]);
    ...
    var installReaderEventHandlers = function(){
        ...
        Dialogs.keyboard.on('ctrl+alt+x', 'reader', function(){
            $(document.body).addClass('hide-ui');
        });
        
        Dialogs.keyboard.on('ctrl+alt+v', 'reader', function(){
            $(document.body).removeClass('hide-ui');
        });

        Dialogs.keyboard.on('ctrl+alt+1', 'reader', prevPage);
        
        $("#previous-page-btn").unbind("click");
        $("#previous-page-btn").on("click", prevPage);

        Dialogs.keyboard.on('ctrl+alt+2', 'reader', nextPage);
        ...
        Dialogs.keyboard.on('ctrl+alt+f', 'reader', toggleFullScreen);
        ...
        Dialogs.keyboard.on('ctrl+alt+b', 'reader', loadlibrary /* function(){setTimeout(, 30);} */ );
        ...
        Dialogs.keyboard.on('ctrl+alt+t', 'reader', tocShowHideToggle);
        ...
        Dialogs.keyboard.on('ctrl+alt+o', 'reader', function(){$('#settings-dialog').modal("show")});
...
// newE.originalEvent.view = window;
            ...
            Dialogs.keyboard.on('ctrl+alt+n', 'reader', function(){
                if (!embedded){
    ...
    var initMediaOverlay = function(){
        ...
        Dialogs.keyboard.on('ctrl+alt+escape', 'reader', readium.reader.escapeMediaOverlay);
        ...
        Dialogs.keyboard.on('ctrl+alt+m, ctrl+alt+space', 'reader', readium.reader.toggleMediaOverlay);
        ...
        Dialogs.keyboard.on('ctrl+alt+l', 'reader', function(){        
            changeRate(false);
        });
        
        Dialogs.keyboard.on('ctrl+alt+j', 'reader', function(){
            changeRate(true);
        });
        ...
        Dialogs.keyboard.on('ctrl+alt+k', 'reader', resetRate);
        ...
        Dialogs.keyboard.on('ctrl+alt+w', 'reader', function(){
            changeVolume(false);
        });
        
        Dialogs.keyboard.on('ctrl+alt+q', 'reader', function(){
            changeVolume(true);
        });
        ...
        Dialogs.keyboard.on('ctrl+alt+a', 'reader', function(){
        ...
        Dialogs.keyboard.on('ctrl+alt+[, ctrl+alt+{', 'reader', readium.reader.previousMediaOverlay);
        
        $previousAudioBtn.on("click", readium.reader.previousMediaOverlay);
        
        Dialogs.keyboard.on('ctrl+alt+], ctrl+alt+}', 'reader', readium.reader.nextMediaOverlay);
