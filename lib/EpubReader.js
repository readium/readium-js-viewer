...
catch (e)
{
    //
        ...
        $('#readium-toc-body').prepend('<button tabindex="50" type="button" class="close" data-dismiss="modal" aria-label="'+Strings.i18n_close+'" title="'+Strings.i18n_close+'"><span aria-hidden="true">&times;</span></button>');
    ...
    var installReaderEventHandlers = function(){
        ...
        Dialogs.keyboard.on(Dialogs.keyboard.ToolbarHide, 'reader', function(){
            $(document.body).addClass('hide-ui');
        });
        
        Dialogs.keyboard.on(Dialogs.keyboard.ToolbarShow, 'reader', function(){
            $(document.body).removeClass('hide-ui');
    ...
    var initReadium = function(){
        ...
        Settings.getMultiple(['reader', url], function(settings){
            ...
            Dialogs.keyboard.on(Dialogs.keyboard.NightTheme, 'reader', function(){
                if (!embedded){
