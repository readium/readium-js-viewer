...
define(['module','jquery', 'bootstrap', 'URIjs', 'Readium', 'Spinner', 'storage/Settings', 'i18n/Strings', 'Dialogs', 'ReaderSettingsDialog', 
        'hgn!templates/about-dialog.html', 'hgn!templates/reader-navbar.html', 'hgn!templates/reader-body.html', 'hgn!templates/reader-body-page-btns.html', 'analytics/Analytics', 'screenfull', 'Keyboard', 'EpubReaderMediaOverlays', 'EpubReaderBackgroundAudioTrack'], 
        function (module, $, bootstrap, URI, Readium, spinner, Settings, Strings, Dialogs, SettingsDialog, AboutDialog, ReaderNavbar, ReaderBody, ReaderBodyPageButtons, Analytics, screenfull, Keyboard, EpubReaderMediaOverlays, EpubReaderBackgroundAudioTrack) {
...
//console.debug("SPIN: -- WILL: " + spinner.willSpin + " IS:" + spinner.isSpinning + " STOP REQ:" + spinner.stopRequested);
    ...
    var loadToc = function(dom){
        ...
        readium.reader.on(ReadiumSDK.Events.CONTENT_DOCUMENT_LOADED, function ($iframe, spineItem)
        {
            ...
            if (wasFixed != isFixed){
                SettingsDialog.updateBookLayout(readium.reader, readium.reader.viewerSettings());
            }
