define(['hgn!templates/settings-dialog.html', 'i18n/Strings', 'keymaster'], function(SettingsDialog, Strings, key){
	var defaultSettings = {
        fontSize: 100,
	...
	var initDialog = function(reader){
        ...
        key('ctrl+alt+s', 'settings', function() {
            save();
            $('#settings-dialog').modal('hide');
        });
        key.unbind('ctrl+alt+c', 'settings');
        key('ctrl+alt+c', 'settings', function() {
            $('#settings-dialog').modal('hide');
        });
