...
// TAKEN FROM https://github.com/levexis/grunt-selenium-webdriver/blob/master/tasks/selenium_webdriver.js
// (Grunt dependency is stripped out, see commented code below)
...
process.on('exit', function onProcessExit() {
    if (started) {
        ...
        return start ( function(){console.log(arguments);} , false, options );
