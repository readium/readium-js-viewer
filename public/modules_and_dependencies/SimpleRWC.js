...
Epub.PackageDocument = Backbone.Model.extend({
    ...
    // Description: This method chooses the appropriate page view to load for individual 
    //   spine items, and sections of the spine. 
    loadSpineItems : function (showSpineIndex) {
        ...
        // });
        this.eagerRenderStrategy(showSpineIndex);
    },
    ...
    eagerRenderStrategy : function (showSpineIndex) {

        var that = this;
        var numPagesViewsToLoad = this.get("loadedPagesViews").length;
        var showPagesView = undefined;

        if (showSpineIndex !== undefined) {
            showPagesView = this.getPagesViewInfo(showSpineIndex).pagesView;
        }
        ...
        _.each(this.get("loadedPagesViews"), function (pagesViewInfo) {
            ...
            pagesViewInfo.pagesView.on("contentDocumentLoaded", function (viewElement) { 
                ...
                if (showPagesView !== undefined && showPagesView === pagesViewInfo.pagesView) {
    ...
    return {
        ...
        render : function (showSpineIndex) { return epubReaderView.render.call(epubReaderView, showSpineIndex); },
    ...
    return {
        ...
        render : function (showSpineIndex) { return epubViewer.render.call(epubViewer, showSpineIndex); },
